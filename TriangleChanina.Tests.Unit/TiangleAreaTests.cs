...
namespace TriangleChanina.Tests.Unit
{
	...
	public class TiangleAreaTests
	{
		...
		[Test]
		public void When_AllSidesPositive_And_EverySideNotLessThenSumOfTheOthers_Then_DoesntThrow()
		{
		...
		[Test]
		public void Given_CorrectSides_And_PrecalculatedArea_Then_PrecalculatedAreaAndAreaByHeronsFormulaShouldBeEqual()
		{
			// inf
			Assert.AreEqual(double.PositiveInfinity, Triangle.GetArea(double.MaxValue, double.MaxValue, double.MaxValue));
			Assert.AreEqual(double.PositiveInfinity, Triangle.GetArea(double.MaxValue, double.MaxValue, double.MaxValue));
			Assert.AreEqual(double.PositiveInfinity, Triangle.GetArea(double.MaxValue, double.MaxValue / 1.5, double.MaxValue / 1.5));
			...
			// calculated in google online calc - low precision
